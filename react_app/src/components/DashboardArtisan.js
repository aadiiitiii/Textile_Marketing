...
import ArtisanProductCard from './layout/ArtisanProductCard';
  ...
  render() {
    ...
    return (
      <div style={{ marginTop: 80 }}>
        <iframe src="localhost:8088/superset/dashboard/5/?standalone=true" />
        <div>
          <Button
            variant="contained"
            style={{
        ...
        <Grid container>
          {jsondata.map(value => (
            <ArtisanProductCard carddata={value} user={user}/>
          ))}
        </Grid>
      </div>
    );
